...
(def-doom-theme doom-gruvbox-mm
  ...
  ((bg
   ...
   (base2      '("#282828" "#282828" "brightblack")) ; bg0 Color used for background in emacs
   ...
   (red         '("#db4934" "#e74c3c" "red"))           ; bright-red
   (magenta     '("#cc241d" "#cc241d" "magenta"))       ; red
   (violet      '("#44aa66" "#d3869b" "brightmagenta")) ; bright-purple
   ...
   (light-green '("#b8bb26" "#b8bb26" "green"))         ; light-green
  ...
  (((font-lock-function-name-face &override) :bold bold)
